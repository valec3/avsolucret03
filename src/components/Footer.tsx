        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-cream/70 text-sm leading-relaxed max-w-md mb-6">
              Especialistas en pulido diamantado, vitrificado, sellado y restauración de superficies. 
              Brindamos acabados profesionales con tecnología industrial en Lima, Perú.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Inicio', 'Servicios', 'Trabajos', 'Precios', 'Contacto'].map((link) => (
                <li key={link}>
                  <a
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gold/20 text-gold text-sm font-medium hover:bg-gold/30 transition-colors"
              >
