...
const contactInfo = [
  ...
  },
  {
    icon: MapPin,
    label: "Ubicación",
    value: "Jr. Aguarico 414, Breña - Lima",
    href: "https://maps.google.com/?q=Jr.+Aguarico+414+Breña+Lima",
  },
  {
    icon: Clock,
    label: "Horario",
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            ...
            <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">
              ¿Listo para <span className="text-gold">transformar</span> tus
              superficies?
            </h2>
            <p className="text-muted-foreground mb-8">
              Contáctanos hoy mismo y recibe una evaluación gratuita. Estamos
              listos para ayudarte a recuperar el brillo de tus pisos.
            </p>
          ...
          >
            <div className="w-full p-8 md:p-12 rounded-3xl bg-card border border-gold/30 text-center">
              ...
              <p className="text-muted-foreground mb-8">
                Escríbenos directamente y recibe una respuesta en menos de 24
                horas. Cotización sin compromiso.
              </p>
